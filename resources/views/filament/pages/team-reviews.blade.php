                ...
                @foreach($review->keyResultReviews as $krReview)
                    ...
                    <div class="rounded-xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 p-4">
                        <div class="flex items-start gap-2 flex-wrap">
                            @if($goal?->code)
                                <span class="text-[11.5px] font-bold text-gray-500 dark:text-gray-400">{{ $goal->code }}{{ $kr?->code ? '.' . $kr->code : '' }}</span>
                            @elseif($kr?->code)
                                <span class="text-[11.5px] font-bold text-gray-500 dark:text-gray-400">{{ $kr->code }}</span>
                            @endif
